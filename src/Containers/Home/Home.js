...
const Home = props => {
  ...
  const handleNavGamePage = () => {
    ...
    navigate('/home/games/riseofthetombraider');
  }
  ...
  const handlePlayDice = () => {
    ...
    setTimeout(() => {
      setBrowsing(true);
      navigate(`/home/games/${randomSurname}`);
    }, 1500);
  }
                ...
                <div className={styles.container}>
                    <div className={styles.left}>
                        <div className={styles.splash}>
                          <h1>L.B Gaming Port</h1>
                          <p className={styles.intro}>The best destination to buy new games to competitive prices. 24 hour support, "best price" guarantee and a flawless experience.</p>
                        </div>
                    ...
                    {/* <div className={styles.right}>
                        <div className={styles.buttonsRight}>
                            ...
                            <a href='https://github.com/gianlucajahn/home/commits/main' target="_blank"><button className={styles.cta} aria-label="Open commit log">
                              <Git className={styles.ctaSVG} />
                              Commit Log
                            </button></a>
                            <a href="https://github.com/gianlucajahn/home/blob/main/README.md#performance" target="_blank"><button className={`${styles.cta} ${styles.lastChild}`} aria-label="Open performance test results">
                              <Performance className={`${styles.ctaSVG}`} />
                              Performance
                            </button></a>
                            <a href="https://github.com/gianlucajahn/home/blob/main/README.md#technologies-used" target="_blank"><button className={`${styles.cta} ${styles.lastChild}`} aria-label="View technologies used"> 
                              <img className={styles.technologies} src={require("../../Resources/image/whatruns.png")} alt="WhatRuns logo"/>
                              Technologies
                            </button></a>
                            <a href="https://github.com/gianlucajahn/home/blob/main/README.md#sources" target="_blank"><button className={`${styles.cta} ${styles.lastChild}`} aria-label="View Sources">
